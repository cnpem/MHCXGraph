...
#
# This file contains code adapted from PyDSSP:
# https://github.com/ShintaroMinami/PyDSSP
#
# Original project: PyDSSP
# Original license: MIT
#
# Modifications for MHCXGraph:
# - Removed the top-level PyTorch backend import to avoid importing torch
#   during MHCXGraph startup.
#
# The original MIT license notice is included in this repository together
# with this adapted file.
